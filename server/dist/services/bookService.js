...
const createBook = (data) => __awaiter(void 0, void 0, void 0, function* () {
    return bookRepository.createBook(Object.assign(Object.assign({}, data), { tglTerbit: new Date(data.tglTerbit) }));
});
exports.createBook = createBook;
const updateBook = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, exports.getBookById)(id);
    return bookRepository.updateBook(id, Object.assign(Object.assign({}, data), { tglTerbit: data.tglTerbit ? new Date(data.tglTerbit) : undefined }));
});
